...
import 'package:recipe_book/primary_progress_indicator.dart';
...
class _HomeScreenMobileState extends State<HomeScreenMobile> {
  ...
  void initState() {
    ...
    debugPrint('Hello from mobile home screen');
  }
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          recipe.title,
                                          style: TextStyle(
                                            fontSize: (22.0 * MediaQuery.of(context).size.width) / 440.0,
